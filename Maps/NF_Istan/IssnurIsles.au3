...
Func VQIssnurIsles()
	...
	Local $aWaypointsA[11][2] = [ [-12890, 6722] _
	, [-14645, 3908] _
	, [-16354, 3022] _
	, [-17843, 3575] _
	, [-20217, 5799] _
	...
	Local $aWaypointsB[29][2] = [ [-15023, -4004] _
	, [-17097, -3336] _
	, [-16181, -5683] _
	, [-16460, -8390] _
	, [-15322, -9976] _
	...
	Local $aWaypointsC[60][2] = [ [9568, -5791] _
	, [11666, -7077] _
	, [13394, -5986] _
	, [13273, -4172] _
	, [15755, -5565] _
	...
	Local $aWaypointsD[15][2] = [ [-1110, 6412] _
	, [-4820, 5146] _
	, [-5739, 2380] _
	, [-6618, 944] _
	, [-4937, -494] _
